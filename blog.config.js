...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小龙iYY', // 您的昵称 例如 小龙ai
  BIO: process.env.NEXT_PUBLIC_BIO || 'Technical Art🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '小龙, 博客', // 网站关键词 英文逗号隔开
